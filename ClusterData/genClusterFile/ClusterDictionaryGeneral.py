...
if __name__ == '__main__':
	...
	cluster_results = ClusterDictionary(typeday_violationcode)
	cluster_results.importCSV('csv/typeday_violationcode_forcluster_top_performers.csv')
	cluster_results.exportCSV('clusterfile/typeday_violationcode_forcluster_top_performers_clusterfile.csv')
