Copy (
	...
	group by pv.violation_time_bucket
	order by pv.violation_time_bucket
) To '/users/timothymeyers/projects/parkingviolations/tim/part1/top_violations_grouped_by_time.csv' With CSV HEADER;